...
/// Session 6 shrink gate: `ask-core@18` + notebook suffix must be on a path
...
final class AskPromptSizeTests: XCTestCase {
    ...
    func test_askCorePlusNotebookSuffix_isAtMost55PercentOfAsk15() {
        ...
        XCTAssertEqual(resolved.version, "ask-core@18")
        let limit = Int(
        ...
        XCTAssertLessThanOrEqual(
            resolved.text.count,
            limit,
            "ask-core@18 + notebook suffix is \(resolved.text.count) chars; "
