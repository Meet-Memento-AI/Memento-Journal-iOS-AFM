...
depends_on: [006, 025]
findings: [no-release-automation, no-altool-validate-in-ci, no-xctestplan, uitests-skipped, coverage-doc-drift, single-sim-destination, watch-unbuilt, storekit-enforce-off]
# Number: 046 on this branch collided with main's evidence-discipline 046 (2026-09).
# Remapped to 052 so the catalog stays unique.
tech_refs: [technology/09-ui-swift6-testing.md, technology/04-evaluations.md]
---

# 052 — CI/CD Pipeline and Release Automation
...
| 8 | ~~Sonar job exits 1 if credentials missing~~ — **fixed on main 2026-09-23** (job skips with a notice) | `security.yml` | — |
