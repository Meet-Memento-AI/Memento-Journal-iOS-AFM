...
| 4 | Latency instrumentation for exactly these stages already exists | `withMemento/Utils/TurnTimings.swift:22–25` — `.firstSentence`, `.ttsActivate`, `.ttsFirstAudio`, `.listenRearm`; `withMemento/Utils/PerfSignposts.swift:25` `speechLoop` category | — (asset to extend) |
