...
**Release CD (spec [046](046-cicd-pipeline-and-release-automation.md), not-started
2026-09-14).** Merge CI is not a release pipeline. The missing train is:
...
- **CI/CD inventory + Apple-shaped release train:** `docs/CICD_PIPELINE.md`
  and spec [046](046-cicd-pipeline-and-release-automation.md).
